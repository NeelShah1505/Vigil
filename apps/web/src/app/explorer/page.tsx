...
export default function ExplorerPage() {
  ...
  const entities = [
    ...
    },
    {
      ...
      url: `${hashscanBase}/topic/0.0.10524552`,
      badge: "HCS_AUDIT",
    },
    {
      ...
      url: `${hashscanBase}/topic/0.0.10524553`,
      badge: "HCS_IDENTITY",
    },
    {
      role: "Scheduled Forward Renewal Transaction",
      id: "0.0.10524570",
      desc: "Time-based scheduled transfer created with waitForExpiry=false for autonomous renewal.",
      url: `${hashscanBase}/schedule/0.0.10524570`,
      badge: "SCHEDULE_TX",
    },
  ];
